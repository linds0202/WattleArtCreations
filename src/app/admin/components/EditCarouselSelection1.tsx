...
export const EditCarouselSelection1 = ({ categories, changeCategories }: EditSplattersProps) => {
    ...
    const handleDeleteImg = (i: number) => {
        ...
        let updatedUrls = categories.cat1.pics.selectionCarousel.filter((url: string, j: number) => j !== i)
    ...
    const existingUrls = categories.cat1.pics.selectionCarousel.map((link:string, i: number) => (
    ...
    return (
        <div className='w-full bg-[#e9e9e9] my-8 p-4 rounded-lg'>
            <p className='text-xl font-semibold mb-4'>Edit {categories.cat1.type} Selection Carousel</p>
            ...
            <Formik
                ...
                onSubmit={(values, actions) => {
                    ...
                    const newPicsArr = [...categories.cat1.pics.selectionCarousel, values.newImgUrl]
            ...
            <Formik
                ...
                onSubmit={(values, actions) => {
                    ...
                    const newSelectionHeroUrl = values.newSelectionHeroUrl !== '' ? values.newSelectionHeroUrl : categories.cat1.pics.selectionHero  
                    const newSelectionBGUrl = values.newSelectionBGUrl !== '' ? values.newSelectionBGUrl : categories.cat1.pics.selectionBG
                ...
                <Form className='w-full flex flex-col items-center'>
                    <div className='w-full border-b border-black pb-8 mt-4 flex justify-between'>
                        <div className='w-1/3 mr-4 flex flex-col'>
                            <label htmlFor="newSelectionHeroUrl">New {categories.cat1.type} Hero Character Url</label>
                            <Field className='border border-[#282828] p-2 rounded-lg' id="newSelectionHeroUrl" name="newSelectionHeroUrl" placeholder="https://..." />
                        </div>

                        <div className='w-1/3 mr-4 flex flex-col'>
                            <label htmlFor="newSelectionBGUrl">New {categories.cat1.type} Hero Background Url</label>
            ...
            <Formik
                ...
                onSubmit={(values, actions) => {
                    ...
                    const newSelectionHeroBlurb = values.newSelectionHeroBlurb !== '' ? values.newSelectionHeroBlurb : categories.cat1.copy.selectionHeroBlurb
                    const newSelectionCarouselBlurb = values.newSelectionCarouselBlurb !== '' ? values.newSelectionCarouselBlurb : categories.cat1.copy.selectionCarouselBlurb
            ...
            >
                <Form className='w-full flex flex-col items-center'>
                    <div className='w-full mt-4 flex justify-between items-center'>
                        <div className='w-3/4 mr-4 flex flex-col'>
                            <label htmlFor="newSelectionHeroBlurb" className='mr-4'>New {categories.cat1.type} Selection Hero Blurb</label>
                            <Field
                                as="textarea"
                                rows="6"
                                cols="60"  
                        ...
                        <div className='w-3/4 mr-4 flex flex-col'>
                            <label htmlFor="newSelectionCarouselBlurb" className='mr-4'>New {categories.cat1.type} Selection Carousel Blurb</label>
                            <Field
                                as="textarea"
                                rows="6"
                                cols="60"  
