...
export const EditCarouselHome2 = ({ categories, changeCategories }: EditSplattersProps) => {
    ...
    const handleDeleteImg = (i: number) => {
        ...
        let updatedUrls = categories.cat2.pics.homeCarousel.filter((url: string, j: number) => j !== i)
    ...
    const existingUrls = categories.cat2.pics.homeCarousel.map((link:string , i: number) => (
    ...
    return (
        <div className='w-full bg-[#e9e9e9] my-8 p-4 rounded-lg'>
            <p className='text-xl font-semibold mb-4'>Edit {categories.cat2.type} Home Carousel</p>
            ...
            <Formik
                ...
                onSubmit={(values, actions) => {
                    ...
                    const newPicsArr = [...categories.cat2.pics.homeCarousel, values.newImgUrl]
            ...
            <Formik
                ...
                onSubmit={(values, actions) => {
                    ...
                    const newHomeBlurb = values.newHomeBlurb !== '' ? values.newHomeBlurb : categories.cat2.copy.homeBlurb
                ...
                <Form className='w-full flex flex-col items-center'>
                    <div className='w-full mt-4 flex justify-between items-center'>
                        <div className='w-3/4 mr-4 flex flex-col'>
                            <label htmlFor="newHomeBlurb" className='mr-4'>New Homepage {categories.cat2.type} Carousel Blurb</label>
                            <Field
                                as="textarea"
                                rows="6"
                                cols="60"  
