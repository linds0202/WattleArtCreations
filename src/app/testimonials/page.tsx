    ...
    return (
        <div className='relative min-h-[100vh] text-white bg-gradient-to-b from-black from-0% via-[#282828] via-40% to-black to-60%'>
            ...
            ? <div className='pb-36 pt-16 md:pt-24 flex flex-col justify-center items-center'>
                ...
                <div className='mt-4 py-8 px-6 md:px-12 flex flex-col xl:flex-row gap-x-8'>

                    <div className='w-full xl:w-6/12 z-20'>
                    ...
                    <div className='w-full xl:w-6/12 flex flex-col items-center'>
                        <div className='z-20'>
                            ...
                            {portrait?.status === 'Completed' && 
                                <button   
                                    className='block w-full md:w-1/2 lg:w-1/3 mx-auto mt-4 text-xl text-white rounded-lg py-2 px-4 bg-gradient-to-r p-[4px] from-[#338cb2] to-[#43b4e4] cursor-pointer hover:scale-105 transition duration-200 ease-in-out'
                ...
                <div className='w-full xl:w-1/2 px-12 xl:px-0 z-20'>
