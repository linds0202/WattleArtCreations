    ...
    <div className='mx-10 flex justify-between'>
      ...
      <div className='w-8/12 flex flex-col justify-start'>
        ...
        <div className='w-[100%] pb-4 border-b-2 border-[#bababa]'>
          ...
          <p className='text-2xl'>Action Center <span className='text-[#0075FF] text-sm'>(Below are tasks that need your attention)</span></p>
        </div>
        ...
        <div className='w-[100%] flex'>
          ...
          <div className='w-5/12 flex flex-col'>
            <ActionCenter portrait={portrait} setPortrait={setPortrait}/>        
