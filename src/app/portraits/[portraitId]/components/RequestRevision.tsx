    ...
    return (
        ...
        >
            ...
            <>
                <div className='flex flex-col justify-center items-center mb-8'>
                    <div className="flex justify-center items-center mb-4">
                        ...
                        <p className='text-3xl text-center font-bold mt-0'>Request Revision</p>
                    ...
                    <div className='w-8/12 mx-auto flex flex-col items-center mb-4 border-2 border-[#2DD42B] rounded-xl p-2'>
                        <p className='text-center text-lg'>Our standard commission process includes <span className='text-[#2DD42B] text-xl font-bold'>2</span> free revisions on the final submitted piece.</p>
                    ...
                    {remainingRevisions === 0 &&
                        <>
                            ...
                            <h4 className='font-bold'>How to request additional revisions</h4>
            ...
            {remainingRevisions > 0
             ...
             : <p className=' text-[#8f8f8f] text-sm mt-8'>Please note that additional revisions may impact the completion timeline of your artwork. We appreciate your understanding and patience as our artists work diligently to create the perfect custom piece for you.</p>
