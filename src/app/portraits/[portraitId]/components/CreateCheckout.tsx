    ...
    const handleComplete = (values: any) => {
        ...
        if (values.complexity !== 1) {
            newAddOns.push({
                ...
                price: (Math.round((portrait.price * categories.customizer.pricing.complexity[values.complexity - 1]) * 100) / 100)
            })
        }
    ...
    >   
        ...
        <Formik
            ...
            <Form className="w-full flex flex-col justify-around items-center">
                ...
                <div className="w-10/12 bg-[#e9e9e9] rounded-xl p-4">
                    <div className="flex justify-between">
                        <p>Complexity</p>
                        <p>${(Math.round((portrait.price * categories.customizer.pricing.complexity[values.complexity - 1]) * 100) / 100).toFixed(2)}</p>
                    </div>
