...
const Home1_cta = ({ setMode, mode }: ModeProps) => {
    ...
    return (
        <div id='cta' className="relative w-full h-full pt-8 mb-60 bg-black">
            <object type="image/svg+xml" data="images/cta/cta_1.svg" className="absolute top-0 left-0 w-[75%] z-10"/> 

            <object type="image/svg+xml" data="images/colored_dots_final.svg" className="absolute top-0 -left-[10%] lg:top-0 lg:-left-[10%] w-[500%] h-[150vh] md:w-[150%] md:h-[35%] lg:w-[120%] lg:h-[110vh] object-cover"/>  
            <object type="image/svg+xml" data="images/colored_dots_final.svg" className="absolute top-[35%] -left-[10%] lg:top-[35%] lg:-left-[10%] w-[500%] h-[150vh] md:w-[150%] md:h-[35%] lg:w-[110%] lg:h-[120vh] object-cover"/>    
            <object type="image/svg+xml" data="images/colored_dots_final.svg" className="absolute top-[70%] -left-[10%] lg:top-[73%] lg:-left-[10%] w-[500%] h-[150vh] md:w-[150%] md:h-[35%] lg:w-[110%] lg:h-[110vh] object-cover"/>          
                ...
                <div className="relative w-11/12 mx-auto mt-20 lg:w-10/12 lg:mt-32 lg:mr-20 lg:self-end flex flex-col lg:flex-row justify-around items-center">
                    {/* <div className="w-full"> */}
                        ...
                        <Link href={{
                            ...
                            className='lg:absolute lg:bottom-[23%] lg:left-[43.5%] w-full lg:w-5/12 xl:w-1/6 mt-8 py-2 px-4 rounded-xl text-black text-center text-2xl font-bold no-underline bg-gradient-to-r from-[#338cb2] to-[#43b4e4] cursor-pointer hover:scale-105 transition duration-200 ease-in-out'
                            // className="text-xl no-underline text-center hover:text-cyan-600"
                        >
                            Customize
                        </Link>
