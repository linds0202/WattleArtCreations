...
const Home2_testimonial = ({ test }: TestimonialProps) => {
    ...
    return (
        <div className="w-11/12 md:w-1/3 mx-2 h-full flex justify-center items-center bg-black rounded-xl" >
            <div 
            ...
            >
                <img src={test.imgUrl} className="w-[250px] h-[300px] object-cover object-top rounded-xl mb-8 top-0 left-0"/>
